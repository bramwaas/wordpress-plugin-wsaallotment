 ...
 * @return void
 */
function wsaallotment_allotment_list() {
	?>
    ...
    <div class="wrap">
        ...
        <div class="tablenav top">
            <div class="alignleft actions">
                <a href="<?php echo admin_url('admin.php?page=wsaallotment_allotment_create'); ?>" title="<?php _e('Add new allotment', 'wsaallotment'); ?>" ><?php _e('Add new', 'wsaallotment'); ?></a>
            </div>
            <br class="clear">
        </div>
        <?php
		...
		if (isset($_GET['allotment_id'])) {
			...
			if (isset($_POST['update'])) {
				...
				$wpdb->update(
						$table_name, //table
						$fields, //data
						array('allotment_id' => $allotment_id), //whergardenere
						array('%s'), //data format
   ...
   <link type="text/css" href="<?php echo plugin_dir_url(  __FILE__ ). 'css/style-admin.css' ?>" rel="stylesheet" />
    <div class="wrap">
        ...
        <?php if (isset($message)): ?><div class="updated"><p><?php echo $message; ?></p></div>
                  <a href="<?php echo admin_url('admin.php?page=wsaallotment_allotment_list') ?>">&laquo; <?php _e('Back to the allotments list', 'wsaallotment'); ?></a>
        <?php endif; ?>
...
function wsaallotment_allotment_create() {
    ...
    <div class="wrap">
        ...
        <?php if (isset($message)): ?><div class="updated"><p><?php echo $message; ?></p></div>
                  <a href="<?php echo admin_url('admin.php?page=wsaallotment_allotment_list') ?>">&laquo; <?php _e('Back to the allotment list', 'wsaallotment'); ?></a>
        <?php endif; ?>
        <form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
             <table class="table wp-list-table widefat fixed">
        	<?php
            ...
            <input type='submit' name="insert" value='Save' title="<?php _e('Save allotment', 'wsaallotment'); ?>" class='button'>
        </form>
    </div>
    <?php
}
